    ...
    <div class="container mx-auto p-6">
        ...
        <form action="" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div class="mb-4">
                ...
                <input type="number" max="500" id="price" name="price" placeholder="Enter item price" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description" placeholder="Enter item description" maxlength="15"
                    rows="4"
