...
<body>
    ...
    <!-- <div class="navbar">
    <img src="img/logo1.png" alt="Logoo">
    ...
    <div class="container">
        ...
        <div id="order-items-modal" class="order-items-modal">
            <div class="modal-content">
                ...
                <div class="buttons" style="display:flex;">
                    ...
                    <button class="btn btn-primary bg-red-100" style="margin:0 1rem;" onclick="confirmOrder()">Confim
                        order</button>
                ...
                while ($row = $result_set->fetch_assoc()) {
                    echo "<div class='food-item'>
                            ...
                            <div class='food-item-details'>
                                <span><strong><span class='orderd-items' id='" . $row['item_id'] . "'>{$row['name']}</span></strong> </span>
                                <span>Rs{$row['price']}</span>
                                <div>Remaining Quantity: {$row['quantity']}</div>
                                <label for='quantity-{$row['item_id']}'>Quantity:</label>
                                <input type='number' id='quantity-{$row['item_id']}' data-price='{$row['price']}' value='0' name='quantity-{$row['item_id']}' min='0' max='{$row['quantity']}' onchange='calculateTotal()'>
                            </div>
                          </div>";
                }
            } else {
        ...
        <div class="order-section " style="font-size:2rem;">
